...
Import-երը **ստատիկ են դիտավորյալ**։ `defineAsyncComponent`-ով բաժանելը ավելի քիչ
կոդ է ուղարկում ամեն tenant-ի, բայց client-ը հիդրատացիայի պահին դեռ chunk չունի,
մինչ server-ը արդեն render է արել ամբողջ թեման — էջը կարող է մնալ loader-ի վրա։
Փորձարկվել է, հետ է բերվել։ Կրկին փորձել միայն ակտիվ թեմայի chunk-ը preload
անելու եղանակի հետ միասին։
