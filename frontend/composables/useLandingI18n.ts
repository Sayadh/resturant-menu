...
const dict: Record<LandingLang, Dict> = {
  hy: {
    ...
    pricing: {
      ...
      proFeatures: ['✨ AI նկարագրություններ', '🌍 AI թարգմանություն', '⚙️ Անձնական կառավարման վահանակ', '📋 Անսահմանափակ ապրանքներ', '🗂️ Անսահմանափակ կատեգորիաներ', '🌍 3 լեզու', '🎨 Բոլոր դիզայնները', '🔳 Գունավոր QR դիզայն՝ լոգոյով', '🛒 Զամբյուղ՝ ապրանքների հավաքման համար', '📷 Անսահմանափակ լուսանկարներ', '👁️ Առկա է / Առկա չէ կարգավիճակ', '⚡ Մենյուի ակնթարթային թարմացում', '🛠️ Տեխնիկական աջակցություն'],
  ...
  ru: {
    ...
    pricing: {
      ...
      proFeatures: ['✨ AI-описания', '🌍 AI-перевод', '⚙️ Личная панель управления', '📋 Неограниченно товаров', '🗂️ Неограниченно категорий', '🌍 3 языка', '🎨 Все дизайны', '🔳 Цветной дизайн QR с логотипом', '🛒 Корзина для сбора товаров', '📷 Неограниченно фото', '👁️ Статус «В наличии / Нет в наличии»', '⚡ Мгновенное обновление меню', '🛠️ Техническая поддержка'],
  ...
  en: {
    ...
    pricing: {
      ...
      proFeatures: ['✨ AI descriptions', '🌍 AI translation', '⚙️ Personal management panel', '📋 Unlimited products', '🗂️ Unlimited categories', '🌍 3 languages', '🎨 All designs', '🔳 Colorful QR design with logo', '🛒 Cart to collect items', '📷 Unlimited photos', '👁️ In stock / Out of stock status', '⚡ Instant menu updates', '🛠️ Technical support'],
