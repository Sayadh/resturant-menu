...
const T: Dict = {
  ...
  cartSettings: { hy: 'Զամբյուղ / պատվեր', ru: 'Корзина / заказ', en: 'Cart / ordering' },
  showCartTotalLabel: { hy: 'Ցույց տալ ընդհանուր գումարը', ru: 'Показывать общую сумму', en: 'Show total amount' },
  serviceChargeLabel: { hy: 'Ավելացնել սպասարկման վճար', ru: 'Добавить плату за обслуживание', en: 'Add service charge' },
  serviceModePercentLabel: { hy: 'Տոկոսով (%)', ru: 'В процентах (%)', en: 'Percent (%)' },
  serviceModeTextLabel: { hy: 'Միայն նշում (առանց թվի)', ru: 'Только пометка (без числа)', en: 'Note only (no number)' },
  servicePercentLabel: { hy: 'Սպասարկման տոկոս', ru: 'Процент обслуживания', en: 'Service %' },
  cartSettingsHint: { hy: 'Այս կարգավորումները ազդում են զամբյուղի (պատվերի) պատուհանի վրա։', ru: 'Эти настройки влияют на окно корзины (заказа).', en: 'These settings affect the cart (order) panel.' },
  bannerTextColorLabel: { hy: 'Banner-ի տեքստի գույն', ru: 'Цвет текста баннера', en: 'Banner text color' },
  textLight: { hy: 'Բաց (սպիտակ)', ru: 'Светлый (белый)', en: 'Light (white)' },
  textDark: { hy: 'Մուգ', ru: 'Тёмный', en: 'Dark' },
  bannerTextHint: { hy: 'Ընտրիր մուգ՝ եթե banner-ի նկարը բաց է, որ վերնագիրը կարդացվի։', ru: 'Выберите тёмный, если фото баннера светлое — чтобы заголовок читался.', en: 'Pick dark if the banner photo is light so the title stays readable.' },
  ...
  coverImage: { hy: 'Հետին ֆոն', ru: 'Фоновое изображение', en: 'Background image' },
  uploadCoverImage: { hy: 'Վերբեռնել ֆոն', ru: 'Загрузить фон', en: 'Upload background' },
  changeCoverImage: { hy: 'Փոխել ֆոնը', ru: 'Изменить фон', en: 'Change background' },
  coverImageHint: {
    hy: 'Ցուցադրվում է Opaline դիզայնի գլխավոր էջին՝ վերնագրի հետևում։ Չվերբեռնելու դեպքում այդ հատվածը մնում է առանց նկարի՝ մաքուր տարբերակով։',
    ru: 'Показывается на главном экране дизайна Opaline, позади названия. Если не загружено, этот блок остаётся без фото — в чистом варианте.',
    en: 'Shown on the Opaline design\'s home screen, behind the restaurant name. If none is uploaded, that section stays plain, with no photo.',
  },
  ...
  slogan: { hy: 'Կարգախոս', ru: 'Слоган', en: 'Slogan' },
  ...
  langEn: { hy: 'Անգլերեն', ru: 'Английский', en: 'English' },
  ...
  ownerCredentials: { hy: 'Մուտքի տվյալներ (հաճախորդ)', ru: 'Данные для входа (клиент)', en: 'Login credentials (client)' },
  passwordKeepHint: { hy: 'Թողեք դատարկ՝ գաղտնաբառը չփոխելու համար', ru: 'Оставьте пустым, чтобы не менять пароль', en: 'Leave blank to keep the current password' },
  passwordTooShort: { hy: 'Գաղտնաբառը պետք է լինի առնվազն 6 նիշ', ru: 'Пароль должен быть не менее 6 символов', en: 'Password must be at least 6 characters' },
  newPasswordPlaceholder: { hy: 'Նոր գաղտնաբառ', ru: 'Новый пароль', en: 'New password' },
