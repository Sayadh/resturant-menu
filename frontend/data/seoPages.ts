...
export const seoPages: Record<string, SeoPage> = {
  'qr-menu': {
    ...
    sections: [
      ...
      { h2: 'QR Menu vs թղթային մենյու', body: 'Թղթային մենյուն ծախսատար է վերատպելու առումով, արագ մաշվում է և ստատիկ է։ QR Menu-ն թարմացվում է անվճար՝ մեկ սեղմումով, միշտ մաքուր է և ցույց է տալիս իրական ժամանակի գներ ու հասանելիություն։ Աճող թվով ռեստորաններ ամբողջովին անցնում են QR Menu-ի։' },
    ...
    faq: [
      { q: 'Ի՞նչ է QR Menu-ն', a: 'QR Menu-ն թվային մենյու է, որը բացվում է հեռախոսով՝ QR կոդը սկանավորելով, առանց թղթային մենյուի և առանց հավելված ներբեռնելու։' },
      { q: 'Ինչպե՞ս ստեղծել QR Menu', a: 'menus.am-ում գրանցվեք, ընտրեք թեմա, լցրեք մենյուն ադմին վահանակից և ստացեք ձեր QR կոդը՝ պատրաստ տպելու։' },
      { q: 'Ի՞նչ արժե QR Menu-ն', a: 'QR Menu-ն menus.am-ում սկսվում է ամսական 4 900 ֏-ից։ Կան Professional և Business փաթեթներ ավելի մեծ հնարավորություններով։' },
  ...
  'online-menu': {
    ...
    faq: [
      { q: 'Ի՞նչ է Online Menu-ն', a: 'Online Menu-ն ձեր մենյուն է առցանց՝ հասանելի հղումով կամ QR կոդով ցանկացած սարքից։' },
  ...
  'restaurant-menu': {
    ...
    faq: [
      { q: 'Ինչպե՞ս ստեղծել ռեստորանի թվային մենյու', a: 'menus.am-ում գրանցվեք, ընտրեք թեմա, լցրեք մենյուն և ստացեք QR կոդ ձեր ռեստորանի համար։' },
  ...
  'qr-menu-armenia': {
    ...
    faq: [
      ...
      { q: 'Ի՞նչ արժե QR Menu-ն Հայաստանում', a: 'menus.am-ում QR Menu-ն սկսվում է ամսական 4 900 ֏-ից՝ Starter փաթեթով։' },
