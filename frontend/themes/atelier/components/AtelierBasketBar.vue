...
<template>
  <Transition name="atl-dock">
    <button
      v-if="order.count > 0"
      type="button"
      class="fixed bottom-5 left-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#111827] text-[#F8FAFC] shadow-[0_24px_50px_-18px_rgba(17,24,39,0.75)] transition hover:bg-[#1E293B] active:scale-95"
    ...
    >
      ...
      <span class="absolute -right-1 -top-1 flex h-6 min-w-6 items-center justify-center rounded-full bg-[#C65D3A] px-1 font-display text-[11px] font-semibold text-[#F8FAFC] ring-2 ring-[#111827]">{{ order.count }}</span>
    </button>
  </Transition>
</template>
